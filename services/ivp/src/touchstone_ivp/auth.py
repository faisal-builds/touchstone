"""Authentication for the IVP API.

Accepts a machine API key (``tsk_...``, validated via control-plane introspection)
or a control-plane user JWT (verified with the shared secret). The resolved org
scopes every policy lookup and decision (multi-tenant isolation).
"""
